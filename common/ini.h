...
protected:
    ...
    */
    struct INIEntry : _Node<INIEntry>
    {
    ...
    */
    struct INISection : _Node<INISection>
    {
...
public:
    ...
    const _List<INISection>& Section_List() const
    {
        return SectionList;
    }
};
