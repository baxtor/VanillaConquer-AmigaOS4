...
template <class T> class _Node : public GenericNode
{
public:
    _List<T>* Main_List(void) const
    {
        return ((_List<T>*)GenericNode::Main_List());
    }
    T* Next(void) const
    {
...
*/
template <class T> class _List : public GenericList
{
public:
    T* First(void) const
    {
