...
*/
char const* RadioClass::Messages[RADIO_COUNT] = {"hisssss",
                                                 "Roger.",
                                                 "Come in.",
                                                 "Over and out.",
...
RadioMessageType RadioClass::Transmit_Message(RadioMessageType message, long& param, RadioClass* to)
{
    ...
    */
    if (/*!Radio &&*/ message == RADIO_HELLO) {
        ...
        if (to->Receive_Message(this, message, (int&)param) == RADIO_ROGER) {
            Radio = to;
            return (RADIO_ROGER);
        }
        return (RADIO_NEGATIVE);
    ...
    return (to->Receive_Message(this, message, (int&)param));
}
